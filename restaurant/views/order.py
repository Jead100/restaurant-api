...
from restaurant.filters import OrderFilter, StrictOrderingFilter
...
from users.permissions import IsCustomer, IsManager, IsManagerOrDeliveryCrew
from users.utils.roles import get_user_role


class OrderViewSet(RestaurantBaseViewSet):
    """
    ...
    def create(self, request, *args, **kwargs):
        ...
        generate order items from cart items, and clear the cart
        after creation.
        """
        user = request.user
